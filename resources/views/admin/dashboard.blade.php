    ...
    <div id="content" class="main-content">
                ...
                <div class="col-xl-4 col-lg-12 col-md-12 col-sm-12 col-12 layout-spacing">
                    <div class="widget widget-chart-two">
                        <div class="widget-heading">
                            ...
                            <div class="w-icon">
                                <a class="btn btn-primary" href="javascript:void(0);"><svg
                    ...
                    <div class="widget widget-account-invoice-three">
                        ...
                        <div class="widget-heading">
                            <div class="wallet-usr-info">
                                <div class="usr-name">
                                    <span><img src="assets/img/profile-32.jpg" alt="admin-profile" class="img-fluid"> Alan
                                        Green</span>
                                </div>
                                <div class="add">
                            ...
                            <div class="table-responsive">
                                <table class="table table-scroll">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <div class="td-content product-name"><img
                                                        src="assets/img/product-headphones.jpg" alt="product">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="td-content product-name"><img src="assets/img/product-shoes.jpg"
                                                        alt="product">
                                                    <div class="align-self-center">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="td-content product-name"><img src="assets/img/product-watch.jpg"
                                                        alt="product">
                                                    <div class="align-self-center">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="td-content product-name"><img
                                                        src="assets/img/product-laptop.jpg" alt="product">
                                                    <div class="align-self-center">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="td-content product-name"><img
                                                        src="assets/img/product-camera.jpg" alt="product">
                                                    <div class="align-self-center">
        ...
        <div class="footer-wrapper">
            <div class="footer-section f-section-1">
                <p class="">Copyright © 2021 <a target="_blank" href="https://mqographics.co.zw">DesignReset</a>, All rights
                    reserved.</p>
            </div>
