...
<body>
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-header" id="loginModalLabel">
                                        <h7 class="modal-title">Add Category</h7>
                                    ...
                                    <div class="modal-body">
                                            ...
                                            <div class="form-group">
                                                <input type="text" class="form-control mb-4"
                                                    id="desscription" name="description" placeholder="Description">
                                            </div>
                                            <button type="button"
                                                class="btn btn-primary mt-2 mb-2 btn-block AddCategoryButton">Add</button>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <script>
        ...
        $(".AddCategoryButton").click(function(ev) {
            ...
            ev.preventDefault();
            if ($("#name").val() == ""
                $(".CompanyResponse").slideUp("slow");
                $(".CompanyResponse").html("<div class='alert alert-danger'>" +
                    "Please fill in category name" +
                    "</div>");
                $(".CompanyResponse").slideDown("slow");
            } else {
                 console.log('ajax');
